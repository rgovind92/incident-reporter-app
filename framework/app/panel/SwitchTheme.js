...
class ColorPicker extends Component {
  ...
  render() {
    ...
    return (
      <Flex full>
        <Flex row alignCenter justifyBetween style={{ margin: 16 }}>
          <Flex row alignCenter>
            <DividerText style={{ width: 100 }}>Primary: </DividerText>
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'primary')}
            >
              <Flex
                style={{
          ...
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'primaryText')}
            >
              <Flex
                style={{
        ...
        <Flex row alignCenter justifyBetween style={{ margin: 16 }}>
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'secondary')}
            >
              <Flex
                style={{
          ...
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'secondaryText')}
            >
              <Flex
                style={{
        ...
        <Flex row alignCenter justifyBetween style={{ margin: 16 }}>
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'accent')}
            >
              <Flex
                style={{
          ...
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'accentText')}
            >
              <Flex
                style={{
        ...
        <Flex row alignCenter justifyBetween style={{ margin: 16 }}>
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'divider')}
            >
              <Flex
                style={{
          ...
          <Flex row alignCenter>
            ...
            <TouchableOpacity
              onPress={this.showColorPicker.bind(null, 'dividerText')}
            >
              <Flex
                style={{
